...
![main screen](/edge-detection-viewer/public/photo2.png)
*Real-time Canny edge detection with performance stats*

<!-- ### Raw Feed Mode
![Raw Feed](screenshots/raw-feed.png)
*Toggle between processed and raw camera feed* -->
